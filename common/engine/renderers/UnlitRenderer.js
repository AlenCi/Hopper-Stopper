...
export class UnlitRenderer extends BaseRenderer {
    ...
    prepareMaterial(material) {
        ...
        let baseTexture, baseSampler;
        if (material.baseTexture) {
            baseTexture = this.prepareImage(material.baseTexture.image).gpuTexture;
            baseSampler = this.prepareSampler(material.baseTexture.sampler).gpuSampler;
        }
